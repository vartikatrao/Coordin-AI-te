...
#         user_message = user_input.get("user_query", "") if isinstance(user_input, dict) else str(user_input)
#         return extract_parameters(user_message)

# class ExtractorTool:
#     """Simple tool class for CrewAI compatibility"""
#     name = "Parameter Extractor Tool"
#     description = "Extracts parameters (location, purpose, mood, budget, time, transport) from user input for place recommendations."
    
#     def __init__(self):
#         pass
    
#     def _run(self, user_input) -> dict:
#         return extractor_tool(user_input)
