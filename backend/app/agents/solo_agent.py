...
# Factory function to create solo agent
def create_solo_agent(default_location: str = "12.9716,77.5946"):
    """Create and return a SoloModeAgent instance"""
    return SoloModeAgent(default_location=default_location)